class Registrar {
    ...
    personaldeGuardia(contentDiv) {
        ...
        var bottomButtons = document.createElement("div");
        bottomButtons.className = "bottom-buttons-div";
        var btnMostrarGuardia = document.createElement("button");
        btnMostrarGuardia.innerText = "Mostrar Guardia";
        btnMostrarGuardia.className = "action-button";

        btnMostrarGuardia.addEventListener("click", () => {
            this.personaldeGuardiaTabla(contentDiv);
            ...
            bottomButtons.appendChild(btnMostrarGuardia);
            contentDiv.appendChild(bottomButtons);
        });
    ...
    personaldeGuardiaTabla(contentDiv) {
        contentDiv.innerHTML = "";
